...
import com.jfranco.multicounter.feature.cart.ui.components.CustomBottomSheets
...
fun CartScreen(viewModel: CartViewModel = viewModel()) {
    ...
    ScaffoldResultHandler(
        ...
        Column(
            ...
            val itemBottomState = state.itemBottomState
            if (itemBottomState is ItemBottomSheetState.Open) {
                CustomBottomSheets(
                    modalSheetState = modalSheetState,
                    cartItem = itemBottomState.item,
                    onDelete = { item ->
